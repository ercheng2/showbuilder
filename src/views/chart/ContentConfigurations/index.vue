...
const { ConstructIcon, FlashIcon, DesktopOutlineIcon, LeafIcon, RocketIcon, HandRightIcon } = icon.ionicons5
...
const ChartInteraction = loadAsyncComponent(() => import('./components/ChartInteraction/index.vue'))
...
const chartsTabList = [
  ...
  {
    key: TabsEnum.CHART_INTERACTION,
    title: '交互',
    icon: HandRightIcon,
    render: ChartInteraction
  }
]
</script>
